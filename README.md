...
* [aixed/WeChat-Hook](https://github.com/aixed/WeChat-Hook) - PC wechat robot interface [wechat Hook] / PC微信4.1.5.30接口 微信Hook 微信机器人 微信Hook源码 PC微信协议 PC微信协议算法
...
* [ashtonjamesd/lavandula](https://github.com/ashtonjamesd/lavandula) - A lightweight web framework in C for building modern web applications
...
* [SlugLab/CXLMemSim](https://github.com/SlugLab/CXLMemSim) - CXLMemSim: A pure software simulated CXL.mem for performance characterization
...
* [rokath/trice](https://github.com/rokath/trice) - 🟢 super fast 🚀 tiny 🐥 𝘾 printf-look-and-feel ✍ trace code, in ⚡ interrupts ⚡ too ‼️, and real-time PC 💻 logging 👀
...
* [RandyGaul/cute_framework](https://github.com/RandyGaul/cute_framework) - The *cutest* framework out there for creating 2D games in C++!
...
* [NaruseMioShirakana/DragonianVoice](https://github.com/NaruseMioShirakana/DragonianVoice) - 多个SVC/TTS的C++推理库
...
* [socketry/cool.io](https://github.com/socketry/cool.io) - Simple evented I/O for Ruby (but please check out Celluloid::IO instead)
